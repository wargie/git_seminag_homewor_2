...
Затем необходимо нажать кнопку `«Create pull request»`. По желанию, можно добавить какой-нибудь комментарий к вашему `pull request`. После этого еще раз нажимаем кнопку `«Create pull request»`.
